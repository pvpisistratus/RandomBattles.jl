...
function play_nn_battle(initial_state::IndividualBattleState, model1, model2)
    state = initial_state
    num_turns = 1
    while true
...
function play_nn_battle(initial_state::State, model1, model2)
    state = initial_state
    num_turns = 1
    while true
        weights1 = get_possible_decisions(state, allow_nothing = true)
...
function play_nn_random_battle(initial_state::IndividualBattleState, model1)
    state = initial_state
    num_turns = 1
    while true
        weights1 = get_possible_decisions(state, allow_nothing = true)
...
function play_nn_random_battle(initial_state::State, model1)
    state = initial_state
    num_turns = 1
    while true
        weights1 = get_possible_decisions(state, allow_nothing = true)
