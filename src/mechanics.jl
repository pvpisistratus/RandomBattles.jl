...
function evaluate_fast_moves(state::BattleState)
    ...
    if next_state.fastMovesPending[1]
        println(next_state.teams[1].mons[next_state.teams[1].active].fastMoveCooldown)
        next_state = @set next_state.teams[1].mons[next_state.teams[1].active].fastMoveCooldown = next_state.teams[1].mons[next_state.teams[1].active].fastMove.cooldown == 0 ? next_state.teams[1].mons[next_state.teams[1].active].fastMove.cooldown : 0
        println(next_state.teams[1].mons[next_state.teams[1].active].fastMoveCooldown)
    ...
    if next_state.fastMovesPending[2]
        next_state = @set next_state.teams[2].mons[next_state.teams[2].active].fastMoveCooldown = next_state.teams[2].mons[next_state.teams[2].active].fastMove.cooldown == 0 ? next_state.teams[2].mons[next_state.teams[2].active].fastMove.cooldown : 0
...
function evaluate_charged_moves(state::BattleState)
    ...
    if cmp > 0
        ...
        next_state = @set next_state.teams[get_other_agent(cmp)].mons[next_state.teams[get_other_agent(cmp)].active].fastMoveCooldown = next_state.teams[get_other_agent(cmp)].mons[next_state.teams[get_other_agent(cmp)].active].fastMoveCooldown == next_state.teams[get_other_agent(cmp)].mons[next_state.teams[get_other_agent(cmp)].active].fastMove.cooldown ? 0 : -500
