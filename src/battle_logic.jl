...
function get_possible_decisions(state::DynamicState, static_state::StaticState; allow_nothing = false)
    ...
    println(activeMon.energy)
    println(activeStaticMon.chargedMoves[1].energy)
    println(activeStaticMon.chargedMoves[2].energy)
    println(activeMon.energy >= activeStaticMon.chargedMoves[1].energy)
    println(activeMon.energy >= activeStaticMon.chargedMoves[2].energy)
